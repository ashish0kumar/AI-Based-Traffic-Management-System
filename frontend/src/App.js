      ...
      <div className='main-container'>
        <div className='left'>
          ...
          <section id="upload" className="upload">
            ...
            <p>Select videos showing different roads at an intersection. Our system will analyze these videos to provide optimized traffic light timings for smoother traffic flow.</p>
